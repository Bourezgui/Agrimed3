...
import com.example.ynaccache.agrimed2.fragment.detailss2;
import com.example.ynaccache.agrimed2.fragment.entete1;
import com.example.ynaccache.agrimed2.fragment.entete2;
...
public class order2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new order2.MyAdapter1(getSupportFragmentManager()));
   ...
   public  class MyAdapter1 extends FragmentPagerAdapter {
        ...
        {
            switch (position){
                case 0 : return new entete2();
                case 1 : return new detailss2();
